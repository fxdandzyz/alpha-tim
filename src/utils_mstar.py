...
from src.models import ResNet12
...
def get_network(args):
    ...
    if args.arch == 'vgg16':
        ...
        net = vgg16_bn()
    elif args.arch == 'racnn' or args.arch == 'racnn_train' or args.arch == 'anp':
        from models.RACNN import RACNN
        net = RACNN(num_classes=args.num_classes)
    # elif args.arch == 'mobilenetv2':
    #     from models.mobilenetv2 import mobilenetv2
    #     net = mobilenetv2()
    elif args.arch == 'mobilenetv2':
        from torchvision.models import mobilenet
        net = mobilenet.mobilenet_v2(num_classes=args.num_classes)
...
def get_training_dataloader(mean, std,batch_size=4, num_workers=2, shuffle=True):
...
def tensor_to_img(x, mean, std, imtype=numpy.uint8):
    ...
    if not isinstance(x, numpy.ndarray):
        ...
        if image_numpy.shape[0] == 1:  # grayscale to RGB
            image_numpy = numpy.tile(image_numpy, (3, 1, 1))
        for i in range(len(mean)):
            image_numpy[i] = image_numpy[i] * std[i] + mean[i]
        image_numpy = image_numpy * 255
        image_numpy = numpy.transpose(image_numpy, (1, 2, 0))  # post-processing: tranpose and scaling
